        ...
        <el-row :gutter="18" style="margin: 30px 120px">
            ...
            <el-col :span="7">
                ...
                >
                    ...
                    <div class="divider div-transparent"></div>
                    <el-col :span="24">
                         <div style="height:50px;font-size: 22px; color: rgb(3, 233, 244); font-weight: 400; margin-left: 10px; margin-top: 10px">
                            Input the Label
                        </div>
                         ...
                         <div style="font-size: 22px; color: rgb(3, 233, 244); font-weight: 400; margin-left: 10px;margin-top:30px">
                            Upload the metadata
                        </div>  
                        <div style="height:60px">
                      <div class="button" >
                    <a href="javascript:;" class="file">Select
                    ...
                    <a href="javascript:;" class="file">upload
                        ...
                        >
                            ...
                            <div class="el-upload__text">Drag the audio to be detected here<em><br> or click here</em></div>
                        </el-upload>
      ...
      handleInputConfirm() {
        ...
        submittask() {
            this.$confirm('This operation will submit the task. Do you want to continue?', 'Tips', {
                ...
                .then(() => {
                    ...
                    let num=this.dynamicTags.length;
        ...
        Upload(file) {
            ...
            async function multipartUpload() {
                ...
                client().multipartUpload(`Dataset/${fileName}`, file.file, {
                        progress: function (p) {
                            //p进度条的值
                            console.log(p);

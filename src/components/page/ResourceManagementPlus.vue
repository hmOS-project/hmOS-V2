    ...
    <div>
        ...
        <el-row :gutter="20"   style="margin-top:45px">
            <el-col :span="12">
                ...
                <div class='resourcemangement_card'>
                    <el-card shadow="hover" style="height: 280px; margin-left: 63px" class="mgb20">
                        <div slot="header" class="clearfix">
                            <span @click="toAddResource">Computing Resource</span>
                        </div>
                        <div id="machine_resource" style="float: left; width: 247px; height: 180px"></div>
                        <div style="float: left; width: 45px; height: 180px">
                        ...
                        <div id="human_resource" style="float: left; width: 247px; height: 180px"></div>
                        <div style="float: left; width: 45px; height: 180px">
                    ...
                    <el-card shadow="hover" style="height: 280px; margin-left: 63px">
                        <div slot="header" class="clearfix">
                            <span>Storage Resource</span>
                        </div>
                        Server Disk（1T）
                        <el-progress :stroke-width="21" :percentage="70" color="#f1e05a"></el-progress>
                        Cloud（10T）
                        <el-progress :stroke-width="21" :percentage="25" color="#42b983"></el-progress>
                        Cache（300G）
                        <el-progress :stroke-width="21" :percentage="10" color="#42b983"></el-progress>
                    </el-card>
                </div>
            </el-col>
            <el-col :span="12">
                <div class='resourcemangement_card'>
                    <el-card shadow="hover" style="height: 280px; margin-right: 63px" class="mgb20">
                        <div slot="header" class="clearfix">
                            <span>Network Resource</span>
                            <!-- <el-button style="float: right; padding: 3px 0" type="text">添加</el-button> -->
                        </div>
                        <div id="internet_up_resource" style="float: left; width: 256px; height: 180px; margin-left: 45px"></div>
                        <div id="internet_down_resource" style="float: left; width: 256px; height: 180px; margin-left: 27px"></div>
                    </el-card>
                    <el-card shadow="hover" style="height: 280px; margin-right: 63px">
                        <div slot="header" class="clearfix">
...
export default {
    ...
    methods: {
        ...
        // 点击“计算资源”，发生页面跳转
        toAddResource() {
            this.$router.push('/resourceListplus');
        }
        // handleListener() {
            ...
            series: [
                {
                    ...
                    data: [
                        { value: 80, name: 'Busy'},
                        { value: 20, name: 'Offline',itemStyle: { color: '#1a9793'} },
                        { value: 60, name: 'Idle',itemStyle: { color: '#42b983'} }
                    ],
                    itemStyle: {
                        emphasis: {
                            shadowBlur: 10,
            ...
            series: [
                {
                    ...
                    data: [
                        { value: 335, name: 'Busy' },
                        { value: 310, name: 'Offline',itemStyle: { color: '#1a9793'} },
                        { value: 234, name: 'Idle',itemStyle: { color: '#42b983'} }
                    ],
                    itemStyle: {
                        emphasis: {
                            shadowBlur: 10,
...
.resourcemangement_card >>> .el-card {
    background-color:rgba(5, 53, 77, 0.7);
    border:1px solid #ebeef500;
    color:rgb(0, 228, 255);
    font-weight: bold;
}
.resourcemangement_card >>> .el-progress__text {
    color:rgb(0, 228, 255);
    line-height: 1.5;
}
.resourcemangement_card >>> .el-card__header {
    background: rgba(0, 168, 255, 0.33);
